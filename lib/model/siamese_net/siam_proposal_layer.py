...
class _SiamProposalLayer(nn.Module):
    """
    ...
    def forward(self, input):
        ...
        pre_nms_topN  = cfg[cfg_key].SIAMESE_RPN_PRE_NMS_TOP_N
        post_nms_topN = cfg[cfg_key].SIAMESE_RPN_POST_NMS_TOP_N
        nms_thresh    = cfg[cfg_key].SIAMESE_RPN_NMS_THRESH
        min_size      = cfg[cfg_key].SIAMESE_RPN_MIN_SIZE
