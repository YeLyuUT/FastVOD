...
class imagenet_10_imgs(imdb):
    def __init__(self, image_set, devkit_path, data_path):
        imdb.__init__(self, 'imagenetDET_10_images_'+image_set)
    ...
    def _load_image_set_index(self):
        ...
        if self._image_set == 'train':
            image_set_file = os.path.join(self._data_path, 'ImageSets', 'trainr_10_imgs.txt')
            image_index = []
